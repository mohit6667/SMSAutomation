package constants.centreManagement;
...
public class CentreManagementConstants {
    ...
    public static String uenNumber = "46478751000";
    public static String taxRegistrationNumber = "46478751000";
    public static String bankName = "City Bank";
    public static String bankAccountNumber = "7852000015640";
    public static String bankBranch = "Chennai";
    public static String bankAccountName = "Test User AB";
    public static String qrCodeFilePath = "\\src\\main\\java\\report\\qrCode.jpg";
    public static String centreAddToasterMessage = "Center created successfully";
    public static String centreEditToasterMessage = "Center updated successfully";
    public static String centreDeleteToasterMessage = "Center deleted successfully";
    public static String effectiveDate = "01-08-2024";
    public static String amount = "50000";
